          ...
          {projects.map((proj: Project, index: number) => (
            <div key={index} className="bg-black/30 p-4 rounded-xl border border-white/5 relative group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 pr-8">
                ...
                <input type="url" placeholder="URL de GitHub (Repositorio)" value={proj.githubUrl || ""} onChange={(e) => handleProjectChange(index, "githubUrl", e.target.value)} className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500/50" />
                <input type="url" placeholder="URL del Proyecto (Live Demo)" value={proj.liveUrl || ""} onChange={(e) => handleProjectChange(index, "liveUrl", e.target.value)} className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500/50" />
                <input type="text" placeholder="Fecha (ej: Julio 2026)" value={proj.date || ""} onChange={(e) => handleProjectChange(index, "date", e.target.value)} className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500/50" />
                <input type="text" placeholder="Contexto (ej: Proyecto Personal)" value={proj.context || ""} onChange={(e) => handleProjectChange(index, "context", e.target.value)} className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-blue-500/50" />
